...
- [ ] **Step 1: 대기자도 신호를 명시적으로 남기게 한다**

`newLaneFixture` 의 이 블록
...
- [ ] **Step 2: 최종 좌표 주석이 여전히 참인지 확인하고, 무엇이 세워진 값인지 적는다**
...
- [ ] **Step 3: 오표기된 실패 문구를 바로잡는다**

`TestLanePanelDrawsEveryRowWithItsAxes` 안의
