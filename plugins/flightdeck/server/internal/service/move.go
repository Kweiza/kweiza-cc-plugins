...
// 그 일반 amend 는 2026-09-16 에 전용 동사 `amend` 로 **열렸다**(DESIGN §11) — 축 셋으로
// 못박힌 채로. 그래서 이 동사는 그 셋을 더더욱 안 건드린다: 같은 축을 두 동사가 물면
// 바로 위가 경고한 그 갈림이 생긴다. 선행(after)의 사후 수정은 여전히 §11 이 "안 만든다"로
// 판정했다. 여기 있던 포인터(옛 셸 도구의
