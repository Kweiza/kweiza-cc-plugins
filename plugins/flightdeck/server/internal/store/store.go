...
//go:embed migrations/014_workspace_members.sql
var migrationWorkspaceMembers string

//go:embed migrations/015_item_after_dep_project.sql
var migrationItemAfterDepProject string
